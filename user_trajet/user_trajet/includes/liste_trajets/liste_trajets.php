...
$user = $_SESSION['users'];
$iduser = $user->id_user;
$affiche_trajets = $database->prepare(" SELECT * FROM trajet where  conducteur='$iduser' ");
...
?>
    ...
    <tr>
        ...
        <td class='text-center ;' style="cursor: pointer;">
            ...
            <a class='mr-3' title='Cliquer pour Modifier'><i class='fa-solid fa-pen-to-square modif_trajet' value="<?php echo $id ?>" style='color:blue'></i></a>
...
include("ajax_file/liste_trajets/modifier_trajet.php");
